...
int main(int argc, char **argv)
{
    ...
    goal1.target_pose.pose.position.x = 0.5;//1.90
    goal1.target_pose.pose.position.y = 0.5;//-1.79
    ...
    goal2.target_pose.pose.position.x = 0.50;//1.9
    goal2.target_pose.pose.position.y = 0.50;//-2.99
    ROS_INFO("goal2.target_pose.pose.position.x = %f",goal2.target_pose.pose.position.x);
    ROS_INFO("goal2.target_pose.pose.position.y = %f",goal2.target_pose.pose.position.y);
